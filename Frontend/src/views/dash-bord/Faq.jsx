...
function Faq() {
    ...
    return (
        <Dash>
            <div>
                <StyledAccordion sx={{ mt: 2 }} expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
                ...
                <StyledAccordion sx={{ mt: 2 }} expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
                ...
                <StyledAccordion sx={{ mt: 2 }} expanded={expanded === 'panel3'} onChange={handleChange('panel3')}>
                ...
                <StyledAccordion sx={{ mt: 2 }} expanded={expanded === 'panel4'} onChange={handleChange('panel4')}>
                ...
                <StyledAccordion sx={{ mt: 2 }} expanded={expanded === 'panel5'} onChange={handleChange('panel5')}>
                ...
                <StyledAccordion sx={{ mt: 2 }} expanded={expanded === 'panel6'} onChange={handleChange('panel6')}>
                ...
                <StyledAccordion sx={{ mt: 2 }} expanded={expanded === 'panel7'} onChange={handleChange('panel7')}>
